@extends('layouts.app', ['role' => 'coordinator', 'active' => 'accessibility-analysis'])
@section('title','Accessibility analysis')
@php($pageTitle = 'Accessibility analysis')
@php($breadcrumbs = ['Accessibility analysis'])

@section('content')
@include('components.page-header', [
  'title' => 'Accessibility analysis',
  'subtitle' => 'Commute feasibility across all pending placements.',
