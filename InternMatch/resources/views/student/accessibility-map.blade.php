@extends('layouts.app', ['role' => 'student', 'active' => 'accessibility-map'])
@section('title','Accessibility map')
@php($pageTitle = 'Accessibility map')
@php($breadcrumbs = ['Accessibility map'])

@section('content')
@include('components.page-header', [
  'title' => 'Accessibility map',
  'subtitle' => 'Establishments plotted against your residence with commute feasibility.',
  'actions' => "<a href='#' class='btn btn-ghost btn-sm'><i class='bi bi-printer me-1'></i>Print</a>",
])
